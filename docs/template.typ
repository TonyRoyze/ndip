...
#let makecoverpage(
  ...
  place(dy: 2cm, rect(width: 100%, inset: 30pt, fill: main-titlebox-fill)[
    #text(fill: white, size: 45pt, font: "Lora", weight: "extralight", [#title])
    #linebreak()
    #linebreak()

    #if (subtitle != none) {
      text(fill: white, size: 20pt, font: "Lora", weight: "light", subtitle)
      linebreak()
      v(-5pt)
      linebreak()
    } else {
    ...
    #text(fill: white, size: 30pt, font: "Lora", weight: "extralight", name)
  ])
}
...
#let maketitlepage(
  ...
  text(size: 14pt)[By]
  parbreak()
  text(size: 14pt, weight: "medium")[#name]
  parbreak()
  // text(size: 14pt, weight: "medium")[Student Number: WT/25/43]
